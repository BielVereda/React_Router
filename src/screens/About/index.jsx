            ...
            <div className="about-body">
                ...
                <main className="about-main">
                    ...
                    <section className="about-section">
                        ...
                        {redQueenActive && (
                            <div className="secret-project-link">
                                <p className="secret-label">⚠ CLASSIFIED PROJECT DETECTED</p>
                                <Link to="/project-alice" className="secret-link">
                                    🎮 ACCESS PROJECT: ALICE
                                </Link>
                            </div>
                        )}
