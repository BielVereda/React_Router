...
const BASE_ITEMS = [
    { id: 1, type: "link", label: "GAMES", to: "/games", size: "1x1", position: { col: 2, row: 2 }, desc: "The complete franchise timeline, game by game, with lore and trivia." },
    { id: 2, type: "link", label: "MOVIES", to: "/movies", size: "1x1", position: { col: 5, row: 1 }, desc: "Live-action and animated productions of the Resident Evil universe." },
    { id: 3, type: "link", label: "3D MODELS", to: "/models3d", size: "2x1", position: { col: 1, row: 3 }, desc: "Community-made 3D models, ready for inspection." },
    { id: 4, type: "link", label: "HISTORY", to: "/history", size: "2x1", position: { col: 4, row: 2 }, desc: "Complete timeline of Resident Evil lore, games, and movies." },
    { id: 5, type: "link", label: "ABOUT", to: "/about", size: "1x1", position: { col: 3, row: 4 }, desc: "The origin and mission of this classified archive." },
    { id: 6, type: "link", label: "CONTACT", to: "/contact", size: "2x1", position: { col: 2, row: 1 }, desc: "Send a direct transmission to the archive team." },
    { id: 7, type: "link", label: "CHARACTERS", to: "/characters", size: "1x1", position: { col: 6, row: 3 }, desc: "Complete dossiers on survivors, operatives, and B.O.W. specimens." },
    { id: 8, type: "link", label: "DOWNLOADS", to: "/downloads", size: "1x1", position: { col: 1, row: 1 }, desc: "Wallpapers, icons, and files for archive collectors." },
];
